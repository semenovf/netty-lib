...
void configure_node<reliable_node_pool_t> (reliable_node_pool_t & node_pool)
{
    ...
    node_pool.on_message_begin([] (node_id id, message_id msgid, std::size_t total_size)
    {
#ifndef NETTY__TRACE_ENABLED
    ...
    node_pool.on_message_progress([] (node_id id, message_id msgid, std::size_t received_size
