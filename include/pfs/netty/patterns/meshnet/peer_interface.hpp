...
//
// Changelog:
//      2025.02.25 Initial version (`node_interface.hpp`).
//      2025.06.30 Added method `set_frame_size()`.
//      2025.12.18 Renamed to `peer_interface.hpp`.
//                 `node_interface` renamed to `peer_interface`.
////////////////////////////////////////////////////////////////////////////////
#pragma once
...
public:
    ...
    virtual void on_reconnection_started (callback_t<void (peer_index_t, socket4_addr, inet4_addr)>) = 0;
    virtual void on_reconnection_stopped (callback_t<void (peer_index_t, socket4_addr, inet4_addr)>) = 0;
