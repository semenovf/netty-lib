...
public:
    ...
    bool enqueue (node_id id, int priority, archive_type data)
    {
...
public: // node_interface
    ...
    class node_interface_impl: public node_interface<node_id, typename Node::archive_type>, protected Node
    {
    ...
    public:
        ...
        void on_global_data_received (callback_t<void (node_id /*last transmitter node*/
            , int /*priority*/, node_id /*sender ID*/, node_id /*receiver ID*/, archive_type)> cb) override
        {
