...
public:
     ...
     *
     * @details If @a src_saddr is multicast address socket will be bind to address @c INADDR_ANY
     *          for @c Windows and to @a src_saddr in other cases. Then it will be joined
     *          to @a src_saddr on @a local_addr interface.
     *          If @a src_saddr is broadcast address socket will be bind to @a src_saddr
     *          and @a local_addr will be ignored.
     *          If @a src_saddr is unicast address socket will be bind to @a src_saddr
     *          and @a local_addr will be ignored.
     */
    NETTY__EXPORT udp_receiver (socket4_addr const & src_saddr, inet4_addr const & local_addr);
