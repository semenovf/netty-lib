...
public:
    ...
    netty::callback_t<void (std::string const &, std::string const &, std::string const &
        , archive_type, std::size_t, std::size_t)> on_message_received
        = [] (std::string const &, std::string const &, std::string const &, archive_type
    ...
    netty::callback_t<void (std::string const &, std::string const &, archive_type
        , std::size_t, std::size_t)> on_report_received
        = [] (std::string const &, std::string const &, archive_type, std::size_t, std::size_t) {};
...
#else
    netty::callback_t<void (std::string const &, std::string const &, int, archive_type
        , std::size_t, std::size_t)> on_data_received
        = [] (std::string const & /*receiver_name*/, std::string const & /*sender_name*/
            , int /*priority*/, archive_type /*bytes*/, std::size_t /*source_index*/
            , std::size_t /*target_index*/) {};
#endif
...
#else
        ptr->on_data_received([this, source_name] (node_id sender_id, int priority, archive_type bytes)
        {
            auto sender_name = node_name_by_id(sender_id);
