...
#include "pfs/netty/patterns/meshnet/input_account.hpp"
...
using input_controller = meshnet_ns::input_controller<Node
    , meshnet_ns::priority_input_account<priority_tracker_t::SIZE, archive_type>>;
