...
#include "pfs/netty/ssl/handshake_pool.hpp"
...
using handshake_pool_t = netty::ssl::handshake_pool;
using connecting_pool_t = netty::connecting_pool<socket_t, netty::connecting_poll_poller_t>;
using listener_pool_t = netty::listener_pool<listener_t, socket_t, netty::listener_poll_poller_t, handshake_pool_t>;
...
{
    handshake_pool_t handshake_pool;
